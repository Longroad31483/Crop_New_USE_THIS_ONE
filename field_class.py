        ...
        if len(self._animals) > 0:
            ...
            for animal in self._animals:
                ...
                if food >= needs ["food need"]:
                    ...
                    #see if there is any aditional food left
                    if additional_food > 0:
                        #remove some adiitional food for this animal
                        additional_food -= 1
    ...
    while not valid:
        try:
            ...
            if 1 <= food <=100:
                ...
                print("Value entered is not valid - please enter a value between 1-100")
        except ValueError:
            print("Value entered is not valid - please enter a value between 1-100")
    #grow the field
    field.grow(light,food,water)
...
def select_animal(length_list):
    valid = False
    while not valid:
        selected = int(input("Please select and animal: "))
        if selected in range(1,length_list +1):
            valid = True
        else:
            print("Please select a valid option")
...
def display_crop_menu():
    ...
    print("2. Wheat")
    print()
    print("0. I dont want to add a crop - return me to the main menu")
    print()
...
def display_animal_menu():
    ...
    print("2. Sheep")
    print()
    print("0.Idont want to add an animal - return me to the main menu")
    print()
...
def manage_field(field):
    ...
    while not exit:
        ...
        if option == 1:
            ...
            print("You have removed this animal: {0}".format(removed_animal))
        elif option == 5:
            manual_grow(field)
        elif option == 6:
            auto_grow(field,30)
            ...
            exit = True
            print()
    print("Thank you for using the field managament program")
